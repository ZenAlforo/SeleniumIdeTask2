...
namespace TestProject1
{
    ...
    public class TestCalculator
    {
        ...
        /*private DriverOptions GetDriverOptions(string driverName)
        {
            switch (driverName)
            {
                case "edge": return new EdgeOptions();
                case "chrome": return new ChromeOptions();
                case "firefox": return new FirefoxOptions();
                default: throw new InvalidOperationException("invalid driver");
            }
        }*/
